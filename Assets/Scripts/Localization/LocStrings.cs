...
namespace CosmicRumble.Localization
{
    ...
    public static class LocStrings
    {
        public static readonly Dictionary<string, string[]> Table = new Dictionary<string, string[]>
        {
            ...
            ["CHARACTER {0}"]    = new[] { "KARAKTER {0}", "角色 {0}", "PERSONAJE {0}", "キャラクター{0}", "캐릭터 {0}", "CHARAKTER {0}" },
            ["Lv {0}"]           = new[] { "Sv {0}", "等级 {0}", "Nv. {0}", "Lv{0}", "레벨 {0}", "Lv. {0}" },
            ["Chest drop"]       = new[] { "Sandık ödülü", "宝箱掉落", "Botín de cofre", "チェスト報酬", "상자 보상", "Truhen-Belohnung" },
            ["Achievement reward"] = new[] { "Başarım ödülü", "成就奖励", "Recompensa de logro", "実績報酬", "업적 보상", "Erfolgs-Belohnung" },
            ...
            ["Waiting for opponent... ({0})"] = new[] { "Rakip bekleniyor... ({0})", "等待对手中...（{0}）", "Esperando oponente... ({0})", "対戦相手を待っています...（{0}）", "상대를 기다리는 중... ({0})", "Warte auf Gegner... ({0})" },
            ["No opponent found - starting against a bot"] = new[] { "Rakip bulunamadı - bota karşı başlıyor", "未找到对手 - 将与机器人对战", "No se encontró oponente: empieza contra un bot", "対戦相手が見つかりません - ボットと対戦します", "상대를 찾지 못했습니다 - 봇과 대전합니다", "Kein Gegner gefunden - Start gegen einen Bot" },
            ...
            ["Connection lost, reconnecting..."] = new[] { "Bağlantı koptu, yeniden bağlanılıyor...", "连接已断开，正在重新连接...", "Conexión perdida, reconectando...", "接続が切断されました。再接続中...", "연결이 끊겼습니다. 재연결 중...", "Verbindung verloren, erneute Verbindung wird hergestellt..." },
            ["Host changed, reconnecting..."] = new[] { "Host değişti, yeniden bağlanılıyor...", "房主已更换，正在重新连接...", "El anfitrión ha cambiado, reconectando...", "ホストが変更されました。再接続中...", "호스트가 변경되었습니다. 재연결 중...", "Host gewechselt, erneute Verbindung wird hergestellt..." },
            ["Match could not be restored."] = new[] { "Maç geri yüklenemedi.", "无法恢复对战。", "No se pudo restaurar la partida.", "対戦を復元できませんでした。", "대전을 복원할 수 없습니다.", "Match konnte nicht wiederhergestellt werden." },
